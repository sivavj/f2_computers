      ...
      <div className="max-w-6xl mx-auto bg-white p-4 lg:flex lg:h-screen lg:items-center">
        <div className="grid md:grid-cols-2 gap-16 items-center relative overflow-hidden p-8 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] before:absolute before:right-0 before:w-[300px] before:bg-black before:h-full max-md:before:hidden">
            ...
            <form>
              <div className="space-y-4 mt-8">
                <input
                  ...
                  className="px-2 py-3 bg-white w-full text-gray-800 text-sm border-b border-gray-300 focus:border-black outline-none"
                />
                <input
                  type="text"
                  placeholder="Street"
                ...
                <textarea
                  ...
                  className="px-2 pt-3 bg-white w-full text-gray-800 text-sm border-b border-gray-300 focus:border-black outline-none"
                ></textarea>
              </div>
          ...
          <div className="z-10 relative h-full max-md:min-h-[350px]">
            <iframe
              src="https://maps.google.com/maps?q=f2 computers, Shop No.269B, 7th St, Coimbatore, Tamil Nadu 641012&t=&z=13&ie=UTF8&iwloc=&output=embed"
